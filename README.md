...
- Connect to `klogsrv` on port 3232 and display the live kernel log in a separate window.
...
- A jailbroken PS5 with a payload listener (Remote JS Server / elf loader) running on the network.
